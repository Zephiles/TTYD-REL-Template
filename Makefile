...
CFLAGS		= -nostdlib -ffunction-sections -fdata-sections -g -Oz -Wall -Wextra -Wno-address-of-packed-member $(MACHDEP) $(INCLUDE)
...
%.gci: %.rel
	@echo packing ... $(notdir $@)
	@$(GCIPACK) $< "rel" "Paper Mario" "REL Template ($(PRINTVER))" $(BANNERFILE) $(ICONFILE) $(GAMECODE)
