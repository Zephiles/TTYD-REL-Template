#ifndef TTYD_FONTMGR_H
#define TTYD_FONTMGR_H
...
extern "C"
{
    ...
    void FontDrawScaleVec(Vec3 *scale);
    void FontDrawCode(float x, float y, uint16_t code);
    void FontDrawCodeMtx(mtx34 matrix, uint16_t code);
    void FontDrawString(float x, float y, const char *text);
    void FontDrawStringPitch(float x, float y, float pitch, const char *text);
    void FontDrawStringVecPitch(Vec3 *position, float pitch, const char *text);
    void FontDrawStringMtx(mtx34 matrix, const char *text);
    void FontDrawStringCenterMtx(mtx34 matrix, const char *text);
